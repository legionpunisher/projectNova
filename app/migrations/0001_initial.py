# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2020-11-05 05:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hood_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Hood')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Hood')),
        ...
        migrations.AddField(
            model_name='business',
            name='hood',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='biz', to='app.Hood'),
        ),
        migrations.AddField(
            model_name='business',
            name='user',
